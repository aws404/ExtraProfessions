...
public class AnnealerScreenHandler extends AbstractFurnaceScreenHandler {
    ...
    public AnnealerScreenHandler(int syncId, PlayerInventory playerInventory) {
        super(ExtraScreenHandlers.ANNEALER, ExtraProfessionsMod.ANNEALING_RECIPE_TYPE, ANNEALING_RECIPE_BOOK_CATEGORY, syncId, playerInventory);
    }
    ...
    public AnnealerScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory, PropertyDelegate propertyDelegate) {
        super(ExtraScreenHandlers.ANNEALER, ExtraProfessionsMod.ANNEALING_RECIPE_TYPE, ANNEALING_RECIPE_BOOK_CATEGORY, syncId, playerInventory, inventory, propertyDelegate);
    }
}
