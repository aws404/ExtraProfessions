...
public class ExtraStructurePools {
    ...
    private static final StructurePool DESERT_SAND_PILE = StructurePools.register(new StructurePool(id("village/desert/sand_pile"), new Identifier("empty"), ImmutableList.of(Pair.of(StructurePoolElement.ofProcessedLegacySingle(sId("village/desert/sand_pile/desert_sand_pile_1"), StructureProcessorLists.EMPTY), 1),Pair.of(StructurePoolElement.ofProcessedLegacySingle(sId("village/desert/sand_pile/desert_sand_pile_2"), StructureProcessorLists.EMPTY), 1), Pair.of(StructurePoolElement.ofProcessedLegacySingle(sId("village/desert/sand_pile/desert_sand_pile_3"), StructureProcessorLists.EMPTY), 1)), StructurePool.Projection.RIGID));

    public static final Map<Identifier, List<Pair<StructurePoolElement, Integer>>> STRUCTURES_POOL_ADDITIONS = Map.of(
            ...
            new Identifier("minecraft:village/desert/houses"), List.of(
				    ...
				    Pair.of(StructurePoolElement.ofLegacySingle(sId("village/desert/houses/desert_glazier_shop_1")).apply(StructurePool.Projection.RIGID), 1)
            ),
            new Identifier("minecraft:village/desert/zombie/houses"), List.of(
			    	...
			    	Pair.of(StructurePoolElement.ofProcessedLegacySingle(sId("village/desert/houses/desert_glazier_shop_1"), StructureProcessorLists.ZOMBIE_DESERT).apply(StructurePool.Projection.RIGID), 1)
            ),
            new Identifier("minecraft:village/savanna/houses"), List.of(
                    ...
                    Pair.of(StructurePoolElement.ofLegacySingle(sId("village/savanna/houses/savanna_glazier_shop_1")).apply(StructurePool.Projection.RIGID), 1)
            ),
            new Identifier("minecraft:village/savanna/zombie/houses"), List.of(
                    ...
                    Pair.of(StructurePoolElement.ofProcessedLegacySingle(sId("village/savanna/houses/savanna_glazier_shop_1"), StructureProcessorLists.ZOMBIE_SAVANNA).apply(StructurePool.Projection.RIGID), 1)
            ),
            new Identifier("minecraft:village/snowy/houses"), List.of(
                    ...
                    Pair.of(StructurePoolElement.ofLegacySingle(sId("village/snowy/houses/snowy_glazier_shop_1")).apply(StructurePool.Projection.RIGID), 1)
            ),
            new Identifier("minecraft:village/snowy/zombie/houses"), List.of(
				    ...
				    Pair.of(StructurePoolElement.ofProcessedLegacySingle(sId("village/snowy/houses/snowy_glazier_shop_1"), StructureProcessorLists.ZOMBIE_SNOWY).apply(StructurePool.Projection.RIGID), 1)
            ),
            new Identifier("minecraft:village/taiga/houses"), List.of(
                    ...
                    Pair.of(StructurePoolElement.ofLegacySingle(sId("village/taiga/houses/taiga_glazier_shop_1")).apply(StructurePool.Projection.RIGID), 1)
            ),
            new Identifier("minecraft:village/taiga/zombie/houses"), List.of(
                    ...
                    Pair.of(StructurePoolElement.ofProcessedLegacySingle(sId("village/taiga/houses/taiga_glazier_shop_1"), StructureProcessorLists.ZOMBIE_TAIGA).apply(StructurePool.Projection.RIGID), 1)
            )
    );
