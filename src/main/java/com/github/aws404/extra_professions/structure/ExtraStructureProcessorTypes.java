...
public class ExtraStructureProcessorTypes {
    ...
    public static final StructureProcessorType<InheritStructureProcessor> INHERIT_STRUCTURE_PROCESSOR = Registry.register(Registry.STRUCTURE_PROCESSOR, id("inherit"), () -> InheritStructureProcessor.CODEC);
