...
public class ExtraStructureProcessors {
    protected static final StructureProcessorType<RandomiseCandlePropertiesProcessor> RANDOMISE_CANDLE_PROPERTIES_PROCESSOR = StructureProcessorType.register(sId("random_candle"), RandomiseCandlePropertiesProcessor.CODEC);
