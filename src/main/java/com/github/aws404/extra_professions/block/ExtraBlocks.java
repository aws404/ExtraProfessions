...
public class ExtraBlocks {
    ...
    public static final Block FEED_TROUGH_BLOCK = Registry.register(Registry.BLOCK, ExtraProfessionsMod.id("feed_trough"), new FeedTroughBlock(FabricBlockSettings.of(Material.METAL).strength(3.5F).sounds(BlockSoundGroup.METAL)));
    ...
    public static final Item FEED_TROUGH_ITEM = Registry.register(Registry.ITEM, ExtraProfessionsMod.id("feed_trough"), new BlockItem(ExtraBlocks.FEED_TROUGH_BLOCK, new FabricItemSettings().group(ItemGroup.DECORATIONS)));
